...
--   never resolve credentials for `postgres`, `authenticator`, `corebase_admin` or
...
CREATE OR REPLACE FUNCTION corebase.pgbouncer_lookup(p_user text)
...
GRANT USAGE ON SCHEMA corebase TO pgbouncer_auth;
