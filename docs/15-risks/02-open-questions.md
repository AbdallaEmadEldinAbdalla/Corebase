...
| OQ-056 | Benchmark real idle RSS of the triplet under PG 17 — the 300 MB figure is literature, not measurement | [multi-tenancy & isolation](../01-architecture/03-multi-tenancy-and-isolation.md) | Milestone 0 |
