...
| `apps/dashboard` | The dashboard: login, signup, org switcher, projects grid, create-project flow, project overview, project usage, project settings with pause and a danger zone, the paused/resuming experience, org members and invitations, and accepting an invitation — Next.js App Router, TanStack Query, session cookies, no BFF |
